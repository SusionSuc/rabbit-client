package com.susion.rabbit.transform
...
import com.susion.rabbit.transform.core.context.RabbitTransformInvocation
import com.susion.rabbit.transform.core.rxentension.file
...
class RabbitTransform : Transform() {
    ...
    override fun getName() = "rabbit-transformStreamToArray"
