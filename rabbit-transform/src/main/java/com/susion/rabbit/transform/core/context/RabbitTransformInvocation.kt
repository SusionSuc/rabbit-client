package com.susion.rabbit.transform.core.context
...
import com.susion.rabbit.transform.core.TransformListener
import com.susion.rabbit.transform.core.asm.Klass
import com.susion.rabbit.transform.core.asm.KlassPool
import com.susion.rabbit.transform.core.rxentension.*
...
internal class RabbitTransformInvocation(private val dInvocation: TransformInvocation) :
    ...
    internal fun doFullTransform() {
        this.inputs.parallelStream().forEach { input ->
            input.directoryInputs.parallelStream().forEach {
                RabbitTransformPrinter.p("rabbit transforming file : ${it.file}")
    ...
    internal class LoadedKlass(val pool: KlassPoolImpl, val clazz: Class<out Any>) :
        ...
        override fun isAssignableFrom(type: String) =
            isAssignableFrom(pool.findClass(normalize(type)))
