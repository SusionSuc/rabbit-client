...
![version](https://img.shields.io/badge/version-1.0.0--alpha13-brightgreen)
...
可以准确统计应用`Applicaiton`创建时间、应用冷启动时间和页面inflate耗时&完全渲染耗时
...
>也可以直接联系我参与到`rabbit`的维护。 个人微信 : SusionSuc
