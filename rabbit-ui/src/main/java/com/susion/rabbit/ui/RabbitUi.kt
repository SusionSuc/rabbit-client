...
import com.susion.rabbit.ui.view.RabbitFloatingView
...
object RabbitUi {
    ...
    fun init(application: Application, config: Config) {
        RabbitUi.application = application
        RabbitUi.config = config
        RabbitUi.application.registerActivityLifecycleCallbacks(object :
            com.susion.rabbit.base.common.RabbitActivityLifecycleWrapper() {
