...
import com.susion.rabbit.ui.utils.device.*
...
object FloatingViewPermissionHelper {
    ...
    fun checkPermission(context: Context): Boolean {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            when {
                com.susion.rabbit.base.common.DeviceUtils.checkIsMiuiRom() -> return miuiPermissionCheck(
                    context
                )
                com.susion.rabbit.base.common.DeviceUtils.checkIsMeizuRom() -> return meizuPermissionCheck(
                    context
                )
                com.susion.rabbit.base.common.DeviceUtils.checkIsHuaweiRom() -> return huaweiPermissionCheck(
                    context
                )
                com.susion.rabbit.base.common.DeviceUtils.checkIs360Rom() -> return qikuPermissionCheck(
                    context
                )
                com.susion.rabbit.base.common.DeviceUtils.checkIsOppoRom() -> return oppoROMPermissionCheck(
                    context
                )
            }
        }
    ...
    fun tryStartFloatingWindowPermission(context: Context) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            when {
                com.susion.rabbit.base.common.DeviceUtils.checkIsMiuiRom() -> miuiROMPermissionApply(
                    context
                )
                com.susion.rabbit.base.common.DeviceUtils.checkIsMeizuRom() -> meizuROMPermissionApply(
                    context
                )
                com.susion.rabbit.base.common.DeviceUtils.checkIsHuaweiRom() -> huaweiROMPermissionApply(
                    context
                )
                com.susion.rabbit.base.common.DeviceUtils.checkIs360Rom() -> ROM360PermissionApply(
                    context
                )
                com.susion.rabbit.base.common.DeviceUtils.checkIsOppoRom() -> oppoROMPermissionApply(
                    context
                )
            }
        } else {
    ...
    private fun commonROMPermissionApply(context: Context) {
        if (com.susion.rabbit.base.common.DeviceUtils.checkIsMeizuRom()) {
